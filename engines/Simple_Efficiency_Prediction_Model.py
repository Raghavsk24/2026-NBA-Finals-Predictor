...
# This is engine 1, the simplest of the three predictors. It uses only offensive rating,
# defensive rating and pace to predict the 2026 NBA Finals after 10,000 monte carlo runs.

# where the shared team stats live and where this engine writes its output
...
# these are the fallback values, overwritten by team_stats.json when data collection has run
NYK = {"name": "New York Knicks", "ortg": 118.7, "drtg": 112.3, "pace": 97.71}
SAS = {"name": "San Antonio Spurs", "ortg": 118.7, "drtg": 110.4, "pace": 100.72}

# Mean defensive rating across all 30 teams
...
def simulate_series(p_nyk_home, p_nyk_away):
    # Play games until one team reaches 4 wins
    nyk_wins = 0
    sas_wins = 0
