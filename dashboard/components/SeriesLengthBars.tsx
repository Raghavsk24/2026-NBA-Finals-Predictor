...
// how likely the series is to last 4, 5, 6 or 7 games, drawn as a small column chart that
// animates its heights when the inputs change
        ...
        return (
          <div key={k} className="flex flex-1 flex-col items-center gap-2">
            ...
            <div className="flex h-24 w-full items-end overflow-hidden rounded-md bg-secondary">
              <motion.div
                className="w-full rounded-md bg-gradient-to-t from-knicks to-knicks-blue"
                initial={false}
